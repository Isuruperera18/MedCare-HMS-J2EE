<%-- 
    ...
    Created on : Apr 26, 2021, 6:51:53 PM
    Author     : Isuru Perera
--%>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="AdminHome.jsp">Admin Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="adminAppointmentList.jsp">Go Back to Appointment List<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container-contact100">
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/AdminAddAppointment" method="post">
