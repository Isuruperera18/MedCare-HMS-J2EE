<%-- 
    Document   : adminPayChannellingList
    Created on : Apr 27, 2021, 3:55:15 PM
    Author     : Isuru Perera
--%>
...
<html>
    <head>
        ...
        <title>E-Channelling Payments Records</title>
        <link rel="stylesheet"
                    ...
                    <div class="table100 ver3 m-b-110">
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from payechannelling where pname like '%" + query + "%' or dname like '%" + query + "%' ";
                                } else {
                                    sql = "select * from payechannelling";
                                }
                                ...
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column5">
                                            <a href="deletePayChannelling.jsp?mobile=<%=mobile%>">Delete</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
