<%-- 
    ...
    Created on : Apr 26, 2021, 7:06:37 PM
    Author     : Isuru Perera
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String s = "SELECT * FROM worker WHERE mobile = '"+mobile+"' ";
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/updateWorker" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Phone is required">
                        <span class="label-input100">Phone_Number:</span>
                        <input class="input100" type="text" value="<%= rs.getString(3)%>" name="Mobile" placeholder="Enter phone number">
                        <span class="focus-input100"></span>
                    </div>
