<%-- 
    Document   : PayCheckups
    Created on : Apr 26, 2021, 10:34:29 PM
    Author     : Isuru Perera
--%>
...
<html>
    <head>
        ...
        <title>Pay for Medical Checkups</title>
        <link rel="stylesheet"
    ...
    <body>
        ...
        <div class="container-contact100">
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/PayMCheckup" method="post">
