<%-- 
    Document   : RecpLogin
    Created on : Apr 24, 2021, 2:49:37 PM
    Author     : Isuru Perera
--%>
...
<html>
    ...
    <body>
        ...
        <!-- Sing in  Form -->
        <form action="<%=request.getContextPath()%>/RecpLogin" method="post">
            <section class="sign-in">
                <div class="container">
                    <div class="signin-content">
                        <div class="signin-image">
                            <figure><img src="img/Recpsignin-image.jpg" alt="sing up image"></figure>
                        </div>
