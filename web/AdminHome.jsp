    ...
    <body>
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="addpatient.jsp">Add Patients</a>
                            <a class="dropdown-item" href="adminPatientList.jsp">View Patients List</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="adminAppointmentList.jsp">Manage Appointments</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="addDoctor.jsp">Add Doctors</a>
                            <a class="dropdown-item" href="adminDoctorList.jsp">View Doctors List</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="adminRecpList.jsp">View Receptionist List</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="addWorker.jsp">Add Workers</a>
                            <a class="dropdown-item" href="adminWorkerList.jsp">View Workers List</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="adminUploadLab.jsp">Upload Lab Reports</a>
                            <a class="dropdown-item" href="LabHome.jsp">Laboratory Department</a>
                        </div>
                    </li>
            ...
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px;">
                <div class="card card-inverse card-info">
                    <div class="card-block bg-info">
                        ...
                        <h6 class="text-uppercase" style="text-align: center"><a href="adminAppointmentList.jsp">Appointments</a></h6>
                        <h1 class="display-1" style="text-align: center"><%=appointment%></h1>
                    </div>
                </div>
            </div>
        ...
        <%
                try {
                    con = DbConnection.initializeDatabase();
                    Statement st = (Statement) con.createStatement();
                    String query = "select count(*) from payechannelling";
                    ResultSet rs = st.executeQuery(query);
                    while (rs.next()) {
                        int payechannelling = rs.getInt(1);
            %>
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px;">
                <div class="card card-inverse card-info">
                    <div class="card-block bg-info">
                        ...
                        <h6 class="text-uppercase" style="text-align: center"><a href="adminPayChannellingList.jsp">E-Channelling Payments</a></h6>
                        <h1 class="display-1" style="text-align: center"><%=payechannelling%></h1>
                    </div>
                </div>
            </div>
        ...
        <%
                try {
                    con = DbConnection.initializeDatabase();
                    Statement st = (Statement) con.createStatement();
                    String query = "select count(*) from paymcheckup";
                    ResultSet rs = st.executeQuery(query);
                    while (rs.next()) {
                        int paymcheckup = rs.getInt(1);
            %>
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px;">
                <div class="card card-inverse card-info">
                    <div class="card-block bg-info">
                        ...
                        <h6 class="text-uppercase" style="text-align: center"><a href="adminPayCheckupsList">Medical Checkup Payments</a></h6>
                        <h1 class="display-1" style="text-align: center"><%=paymcheckup%></h1>
                    </div>
                </div>
            </div>
        </div>
