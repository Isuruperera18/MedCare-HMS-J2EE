<%-- 
    Document   : DoctorGSList
    Created on : Apr 26, 2021, 1:40:28 PM
    Author     : Isuru Perera
--%>
                    ...
                    <div class="table100 ver3 m-b-110">
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from doctorgs where dname like '%" + query + "%' or ahospital like '%" + query + "%' ";
                                } else {
                                    sql = "select * from doctorgs";
                                }
