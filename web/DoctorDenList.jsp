<%-- 
    Document   : DoctorDenList
    Created on : Apr 26, 2021, 1:41:40 PM
    Author     : Isuru Perera
--%>
...
<html>
    <head>
        ...
        <title>Doctor Dentist List</title>
        <link rel="stylesheet"
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="patientAppointment.jsp">E-Channelling</a>
                    </li>
                </ul>
            </div>
        </nav>
                    ...
                    <div class="table100 ver3 m-b-110">
                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        <th class="cell100 column1">Doctor Name</th>
                                        <th class="cell100 column2">Available Hospitals</th>
                                        <th class="cell100 column3">Charges</th>
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from doctorden where dname like '%" + query + "%' or ahospital like '%" + query + "%' ";
                                } else {
                                    sql = "select * from doctorden";
                                }
