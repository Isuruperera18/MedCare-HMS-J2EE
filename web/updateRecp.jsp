<%-- 
    Document   : updateRecp
    Created on : Apr 24, 2021, 10:23:23 PM
    Author     : Isuru Perera
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String s = "SELECT * FROM recp WHERE uname = '"+uname+"' ";
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/updateRecp" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Phone is required">
                        ...
                        <input class="input100" type="text" value="<%= rs.getString(6)%>" name="Mobile" placeholder="Enter phone number">
                        <span class="focus-input100"></span>
                    </div>
