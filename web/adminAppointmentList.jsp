<%-- 
    ...
    Created on : Apr 25, 2021, 7:28:31 AM
    Author     : Isuru Perera
--%>
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="adminAppointment.jsp">Add a Appointment</a>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="table100 ver3 m-b-110">
                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column4">Patient Status</th>
                                        <th class="cell100 column5">Appointment Type</th>
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from appointment where pname like '%" + query + "%' or dname like '%" + query + "%' ";
                                } else {
                                ...
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column7">
                                            <a href="updateAppointment.jsp?mobile=<%=mobile%>">Update</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="deleteAppointment.jsp?mobile=<%=mobile%>">Cancel</a> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
