                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column10">Specialization</th>
                                        <th class="cell100 column11">Date</th>
                            ...
                            <table>
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column11"><%=rs.getString(12)%></td>
                                        <td class="cell100 column12">
                                            <a href="updateDoctor.jsp?uname=<%=uname%>">Update</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="deleteDoctor.jsp?uname=<%=uname%>">Delete</a>                     
                                        </td>
                                    </tr>
                                </tbody>
                                <%
