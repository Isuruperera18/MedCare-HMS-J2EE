...
public class updateRecp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet updateRecp</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet updateRecp at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("update recp set fname = ? , lname = ? , pass = ? , email = ? , mobile = ? "  + " where uname = ?");
